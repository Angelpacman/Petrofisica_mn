...
P_final = [1.4847, 1.414, 1.2898, 1.4847]
P_M1=[0.5241,0.6273]
P_M2=[0.7781,0.8091]
v_x1=[0.5241,0.5241]
v_y1=[0.7781,0.95]
...
main_ax.plot(M, L, marker='o', linestyle='', markersize=4, alpha=0.3, color ='orange')
...
x_hist.hist(M, 150, histtype='stepfilled',orientation='vertical', color='orange')
x_hist.grid()
#x_hist.invert_yaxis()
...
x_hist.set_ylabel('M frequency')
main_ax.set_xlabel('M')
